...
class GenPDF():
    def __init__(self,pPath,pEntreprise,pContact,pAdresse,PSexe):
        ...
        pdf.multi_cell(0, 6, txt=" Je souhaite intégrer dès la rentrée de Septembre 2020 la Formation BAC+3 CSIA en Alternance chez vous à l’IUMM Loire de Saint–Etienne et par la suite valider le niveau BAC+5.".encode('latin-1', 'replace').decode('latin-1').replace("?","'"), align="L")
        pdf.ln()
