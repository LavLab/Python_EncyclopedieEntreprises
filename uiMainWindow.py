...
class Ui_uiMainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.contacts_textEdit_adresse.setGeometry(QtCore.QRect(270, 130, 231, 51))
        self.contacts_textEdit_adresse.setPlainText("")
        ...
        self.line_3.setGeometry(QtCore.QRect(40, 30, 191, 31))
        self.line_3.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_3.setLineWidth(2)
        self.line_3.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_3.setObjectName("line_3")
        self.line_4 = QtWidgets.QFrame(self.frame)
        self.line_4.setGeometry(QtCore.QRect(231, 10, 20, 21))
        self.line_4.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_4.setLineWidth(2)
        self.line_4.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_4.setObjectName("line_4")
        self.line_5 = QtWidgets.QFrame(self.frame)
        self.line_5.setGeometry(QtCore.QRect(230, 60, 20, 21))
        self.line_5.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_5.setLineWidth(2)
        self.line_5.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_5.setObjectName("line_5")
        self.line_6 = QtWidgets.QFrame(self.frame)
        self.line_6.setGeometry(QtCore.QRect(220, 20, 20, 51))
        self.line_6.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_6.setLineWidth(2)
        self.line_6.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_6.setObjectName("line_6")
        self.contacts_input_codepostal = QtWidgets.QSpinBox(self.tab_contacts)
        self.contacts_input_codepostal.setGeometry(QtCore.QRect(270, 190, 51, 31))
        self.contacts_input_codepostal.setAlignment(QtCore.Qt.AlignCenter)
        self.contacts_input_codepostal.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.contacts_input_codepostal.setMaximum(99999)
        self.contacts_input_codepostal.setProperty("value", 0)
        self.contacts_input_codepostal.setObjectName("contacts_input_codepostal")
        self.contacts_combobox_ville = QtWidgets.QComboBox(self.tab_contacts)
        self.contacts_combobox_ville.setGeometry(QtCore.QRect(330, 190, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.contacts_combobox_ville.setFont(font)
        self.contacts_combobox_ville.setEditable(False)
        self.contacts_combobox_ville.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToMinimumContentsLength)
        self.contacts_combobox_ville.setObjectName("contacts_combobox_ville")
        self.frame.raise_()
        ...
        self.contacts_input_codepostal.raise_()
        self.contacts_combobox_ville.raise_()
